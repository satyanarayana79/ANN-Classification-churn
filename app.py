...
# ✅ Prepare input data (include Geography)
...
# ✅ Final input dataframe (same as training format)
final_input = pd.concat([input_data.drop("Geography", axis=1), geo_encoded_df], axis=1)
